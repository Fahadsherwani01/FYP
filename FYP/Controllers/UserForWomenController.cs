...
{
    public class UserForWomenController : Controller
    {
        ...
        public IActionResult Selector(string key, string img)
        {
            ...
            if (_signInManager.IsSignedIn(User))
            {
                 IEnumerable<string> subCategory = (from p in mycon.tableForWomen
        ...
        public IActionResult MSelector(string key)
        {
            ...
            if (_signInManager.IsSignedIn(User))
            {
                ...
                var subCategory = (from p in mycon.tableForWomen
