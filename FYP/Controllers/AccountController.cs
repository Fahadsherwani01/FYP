...
using FYP.Models;
using FYP.Models.AccountViewModels;
using FYP.Services;
...
namespace FYP.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //    if (!await _userManager.IsInRoleAsync(user, accountManagerRole.UserName))
        //    {
        //        await _userManager.AddToRoleAsync(user, accountManagerRole.UserName);
        //    }
